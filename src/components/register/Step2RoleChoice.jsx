  ...
  return (
    <div className="space-y-6">
      <h2 className="text-2xl font-bold text-center">
        Étape 2: Quel sera votre rôle ?
      </h2>
      <p className="text-center text-muted-foreground">
        Choisissez comment vous souhaitez participer au dictionnaire.
      </p>
        ...
        <motion.div whileHover={{ y: -5 }}>
          ...
          >
            <CardHeader className="items-center text-center">
              ...
              <CardDescription>
                Explorez, commentez et proposez des améliorations.
              </CardDescription>
            </CardHeader>
        ...
        <motion.div whileHover={{ y: -5 }}>
          ...
          >
            <CardHeader className="items-center text-center">
              ...
              <CardDescription>
                Publiez et éditez directement des termes (profil vérifié).
              </CardDescription>
            </CardHeader>
            <CardContent className="text-center">
              <Button variant="outline">Choisir ce rôle</Button>
